#ifndef ED301V2_PROVIDER_INTERNAL_H
#define ED301V2_PROVIDER_INTERNAL_H

/*
 * Internal contract between the C provider shim and the Rust callback table
 * for the experimental Ed301-EdDSA-v2 signature-only provider.
 *
...
typedef struct ed301v2_signature_rust_api_st {
...
} ED301V2_SIGNATURE_RUST_API;

typedef struct ed301v2_provider_context_st {
