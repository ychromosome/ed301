 ...
 */
static inline int ed301v2_param_set_optional_int(
...
static inline int ed301v2_param_set_optional_utf8_ptr(
    OSSL_PARAM *parameter,
    const char *value)
{
...
static inline int ed301v2_param_set_optional_utf8_string(
    OSSL_PARAM *parameter,
    const char *value)
{
    return parameter == NULL
...
static inline int ed301v2_param_set_optional_octet_string(
    OSSL_PARAM *parameter,
 ...
 * OCTET_PTR.  The Ed301-EdDSA-v2 key encodings require the former, a non-NULL
 ...
 */
static inline int ed301v2_param_get_strict_octet_string(
