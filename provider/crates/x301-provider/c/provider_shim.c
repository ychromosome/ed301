...
#if OPENSSL_VERSION_MAJOR != 3 && OPENSSL_VERSION_MAJOR != 4
# error "The X301 provider requires OpenSSL ABI major 3 or 4 headers"
#else

#include "provider_internal.h"
#include "../../../common/generated_x301_profile.h"

#define CURVE301_PROVIDER_CONTEXT X301_PROVIDER_CONTEXT
#define CURVE301_KEY X301_KEY
#define CURVE301_SECURITY_BITS X301_SECURITY_BITS
#define CURVE301_SEED_BYTES X301_BYTES
#define CURVE301_PUBLIC_KEY_BYTES X301_BYTES
#define CURVE301_PKCS8_SALT_BYTES ((size_t)16)
#define CURVE301_DISPLAY_NAME "X301"
#define CURVE301_HAS_TEST_DECODER X301_HAS_TEST_DECODER
#define CURVE301_HAS_PRIVATE_KEY_DECODER X301_HAS_PRIVATE_KEY_DECODER
#define CURVE301_HAS_TEXT_ENCODER X301_HAS_TEXT_ENCODER
#define CURVE301_ALGORITHM_NAME X301_NAME
#define CURVE301_ALGORITHM_NAMES X301_ALGORITHM_NAMES
#define CURVE301_OPERATION_ALGORITHM_NAMES X301_OPERATION_ALGORITHM_NAMES
#define CURVE301_DECODER_ALGORITHM_NAMES X301_DECODER_ALGORITHM_NAMES
#define CURVE301_PROVIDER_BASENAME X301_PROVIDER_BASENAME
#define CURVE301_PKCS8_PREFIX X301V2_PKCS8_PREFIX
#define CURVE301_SPKI_PREFIX X301V2_SPKI_PREFIX
#define CURVE301_OID_TLV_BYTES X301V2_OID_TLV_BYTES
#define CURVE301_MAX_ENCODED_KEY_BYTES X301V2_MAX_ENCODED_KEY_BYTES
#define CURVE301_R_ALLOCATION_FAILURE X301_R_ALLOCATION_FAILURE
#define CURVE301_R_SERIALIZATION_FAILURE X301_R_SERIALIZATION_FAILURE
#define curve301_allocate x301_allocate
#define curve301_clear_free x301_clear_free
#define curve301_raise X301_RAISE
#define curve301_selection_supported x301_selection_supported
#define curve301_wants_private x301_wants_private
#define curve301_wants_public x301_wants_public
#define curve301_key_new x301_key_new
#define curve301_key_free x301_key_free
#define curve301_key_import x301_key_import
#define curve301_key_export x301_key_export
...
# define X301_MLKEM1024_TLS_GROUP_ID X301V2_TLS_HYBRID_GROUP_ID
...
#else
static const char X301_PROVIDER_BUILDINFO[] =
    "raw X301-v2 KEYMGMT/KEYEXCH";
#endif
static const char X301_NAME[] = "X301";
static const char X301_ALGORITHM_NAMES[] = "X301:X301-v2";
#if defined(X301_ENABLE_HYBRID_MLKEM1024)
static const char X301_MLKEM1024_NAME[] = "X301MLKEM1024";
static const char X301_MLKEM1024_ALGORITHM_NAMES[] = "X301MLKEM1024:X301MLKEM1024-v2";
#endif
#if defined(X301_TEST_FAILPOINT_ARTIFACT)
# define X301_PROVIDER_BASENAME "x301_v2_failpoint"
#elif defined(X301_ENABLE_HYBRID_MLKEM1024)
# define X301_PROVIDER_BASENAME "x301_v2_tls_test"
#elif defined(X301_PKI_EXPERIMENT_ARTIFACT)
# define X301_PROVIDER_BASENAME "x301_v2_pki_test"
#else
# define X301_PROVIDER_BASENAME "x301_v2"
#endif
static const char X301_PROPERTIES[] = "provider=" X301_PROVIDER_BASENAME;
#define X301_DECODER_ALGORITHM_NAMES "X301:X301-v2:" X301V2_OID_TEXT
#if defined(X301_ENABLE_HYBRID_MLKEM1024)
# define X301_HAS_TEST_DECODER 1
# define X301_HAS_PRIVATE_KEY_DECODER 1
# define X301_HAS_TEXT_ENCODER 1
# define X301_OPERATION_ALGORITHM_NAMES X301_DECODER_ALGORITHM_NAMES
#else
# define X301_HAS_TEST_DECODER 0
# define X301_HAS_PRIVATE_KEY_DECODER 0
# define X301_HAS_TEXT_ENCODER 0
# define X301_OPERATION_ALGORITHM_NAMES X301_ALGORITHM_NAMES
#endif
#if defined(X301_ENABLE_HYBRID_MLKEM1024)
...
static const OSSL_ITEM X301_REASON_STRINGS[] = {
    ...
    { X301_R_SERIALIZATION_FAILURE, "X301 serialization failure" },
    { 0, NULL }
};
    ...
    size_t output_length)
{
    ...
    return provider != NULL && output != NULL && output_length == X301_BYTES
        && curve301_fill_random(provider, output, output_length, 1) == 1;
}
    ...
    void *callback_argument)
{
    ...
    if (generation->selection == OSSL_KEYMGMT_SELECT_ALL_PARAMETERS) {
        ...
        /* D1 resamples only WeakSecret; all other failures terminate. */
...
static void *x301_key_load(const void *reference, size_t reference_size)
{
...
static const OSSL_DISPATCH X301_KEYMGMT_DISPATCH[] = {
    ...
    { OSSL_FUNC_KEYMGMT_LOAD, (void (*)(void))x301_key_load },
    ...
    void *callback_argument)
{
    ...
    unsigned int raw_group_id = X301V2_TLS_RAW_GROUP_ID;
    unsigned int raw_security_bits = X301_SECURITY_BITS;
    unsigned int raw_is_kem = 0;
    ...
    OSSL_PARAM raw_group_parameters[] = {
        OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_NAME,
            (char *)X301_NAME, sizeof(X301_NAME)),
        OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_NAME_INTERNAL,
            (char *)X301_NAME, sizeof(X301_NAME)),
        OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_ALG,
            (char *)X301_NAME, sizeof(X301_NAME)),
        OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_GROUP_ID, &raw_group_id),
        OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_GROUP_SECURITY_BITS,
            &raw_security_bits),
        OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_GROUP_IS_KEM, &raw_is_kem),
        OSSL_PARAM_int(OSSL_CAPABILITY_TLS_GROUP_MIN_TLS, &minimum_tls),
        OSSL_PARAM_int(OSSL_CAPABILITY_TLS_GROUP_MAX_TLS, &maximum_tls),
        OSSL_PARAM_int(OSSL_CAPABILITY_TLS_GROUP_MIN_DTLS, &minimum_dtls),
        OSSL_PARAM_int(OSSL_CAPABILITY_TLS_GROUP_MAX_DTLS, &maximum_dtls),
    ...
    if (mlkem != NULL) {
        ...
        if (callback(hybrid_group_parameters, callback_argument) != 1)
            return 0;
    }
    /* Discovery does not put a group in libssl's DEFAULT list. The local
     * integration's default list contains only the hybrid; Raw requires an
     * explicit X301 group selection and is a test path without ML-KEM. */
    return callback(raw_group_parameters, callback_argument);
}
#endif
...
#endif /* supported OpenSSL ABI major */
