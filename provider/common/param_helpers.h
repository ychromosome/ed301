#ifndef CURVE301_PARAM_HELPERS_H
#define CURVE301_PARAM_HELPERS_H
 ...
 */
static inline int curve301_param_set_optional_int(
...
static inline int curve301_param_set_optional_utf8_ptr(
    OSSL_PARAM *parameter,
    const char *value)
{
...
static inline int curve301_param_set_optional_utf8_string(
    OSSL_PARAM *parameter,
    const char *value)
{
    return parameter == NULL
...
static inline int curve301_param_set_optional_octet_string(
    OSSL_PARAM *parameter,
 ...
 * OCTET_PTR.  The v2 key encodings require the former, a non-NULL
 ...
 */
static inline int curve301_param_get_strict_octet_string(
