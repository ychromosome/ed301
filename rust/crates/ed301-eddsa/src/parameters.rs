//! Public identifiers and sizes fixed by `Ed301-EdDSA-v2`.

/// Versioned identifier of this signature profile.
pub const SPECIFICATION: &str = "Ed301-EdDSA-v2";

/// Native signature-domain label, following the RFC 8032 Ed448 `dom4` shape.
pub const SIGNATURE_DOMAIN: &[u8; 11] = b"SigEd301-v2";
...
pub const PARAMETER_SET: &str = "ED301-v2";
...
/// Exact SHAKE256 output length used by Ed301-EdDSA-v2.
...
pub const EDWARDS_A: u64 = crate::generated_parameters::EDWARDS_A;

/// Twisted-Edwards coefficient `d`.
pub const EDWARDS_D: i16 = crate::generated_parameters::EDWARDS_D;
