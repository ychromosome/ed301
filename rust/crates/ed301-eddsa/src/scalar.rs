...
const_monty_params!(
    ScalarModulus,
    U320,
    generated_parameters::SCALAR_MODULUS_HEX,
...
const MODULUS: U320 = U320::from_be_hex(generated_parameters::SCALAR_MODULUS_HEX);
...
mod tests {
    ...
    const L_BYTES: [u8; 38] = generated_parameters::PRIME_ORDER_ENCODING;
    // Generated with Python integers; the test below uses crypto-bigint division.
    const RADIX_304_REDUCED: U320 = U320::from_be_hex(generated_parameters::RADIX_304_REDUCED_HEX);
