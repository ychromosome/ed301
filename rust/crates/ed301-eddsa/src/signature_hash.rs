//! Exact SHAKE256 transcript operations for `Ed301-EdDSA-v2`.
...
///
/// The complete domain is `"SigEd301-v2" || octet(0) ||
/// octet(context.len()) || context`. The zero octet is the fixed PureEdDSA
/// prehash flag; Ed301-EdDSA-v2 defines no prehash instance.
#[derive(Clone, Copy)]
