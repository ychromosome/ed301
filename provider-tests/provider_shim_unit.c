...
static unsigned char unit_context[ED301V2_MAX_CONTEXT_BYTES];
...
{
    const OSSL_DISPATCH *dispatch = ED301V2_SIGNATURE_DISPATCH;
...
static void unit_test_digest_reinit_contract(
    ED301V2_SIGNATURE_RUST_API *api,
    int verification)
{
    ...
    unit_digest_init_fn init = verification
        ? ed301v2_signature_digest_verify_init
        : ed301v2_signature_digest_sign_init;
    ...
    ED301V2_CHECK(init(&signature, NULL, NULL, NULL) == 1
            && unit_signature_reset_calls == 0
    ...
    unit_verify_init_calls = 0;
    unit_error_reason = 0;
    ED301V2_CHECK(init(&signature, "SHA256", NULL, NULL) == 0
            && unit_signature_reset_calls == 0
            && (verification ? unit_verify_init_calls
                             : unit_sign_init_calls) == 0
            && (verification ? unit_verify_key_bound
                             : unit_sign_key_bound) == 1
            && unit_error_reason == ED301V2_R_UNSUPPORTED_MODE,
    ...
    unit_verify_key_bound = verification;
    unit_error_reason = 0;
    ED301V2_CHECK(init(&signature, NULL, NULL, bad_params) == 0
            && unit_signature_reset_calls == 0
            && (verification ? unit_verify_init_calls
                             : unit_sign_init_calls) == 1
            && (verification ? unit_verify_key_bound
    ...
    unit_verify_key_bound = verification;
    unit_error_reason = 0;
    ED301V2_CHECK(init(&signature, "SHA256", &key, NULL) == 0
            && unit_signature_reset_calls == 0
            && (verification ? unit_verify_init_calls
                             : unit_sign_init_calls) == 0
            && (verification ? unit_verify_key_bound
    ...
    unit_sign_key_bound = !verification;
    unit_verify_key_bound = verification;
    ED301V2_CHECK(init(&signature, NULL, &key, bad_params) == 0
    ...
    ED301V2_CHECK(init(&signature, NULL, NULL, NULL) == 0
            && unit_signature_reset_calls == 0
            && (verification ? unit_verify_init_calls
                             : unit_sign_init_calls) == 1
            && (verification ? unit_verify_key_bound
    ...
    unit_sign_key_bound = !verification;
    unit_verify_key_bound = verification;
    ED301V2_CHECK(init(&signature, NULL, &key, NULL) == 1
            && unit_signature_reset_calls == 1
            && (verification ? unit_verify_init_calls
                             : unit_sign_init_calls) == 1
            && (verification ? unit_verify_key_bound
...
static void unit_fill_api(ED301V2_SIGNATURE_RUST_API *api)
{
    ...
    api->seed_bytes = ED301V2_SEED_BYTES;
    api->public_key_bytes = ED301V2_PUBLIC_KEY_BYTES;
    api->signature_bytes = ED301V2_SIGNATURE_BYTES;
...
#define EXPECT_MISSING_CALLBACK(api, field) \
    do { \
        ED301V2_SIGNATURE_RUST_API candidate = *(api); \
        candidate.field = NULL; \
        ED301V2_CHECK(!ed301v2_rust_api_valid(&candidate), \
...
int main(void)
{
    ...
    ED301V2_PROVIDER_CONTEXT codec_provider = { 0 };
    CURVE301_CODEC_CONTEXT codec = { 0 };
    OSSL_PARAM cipher[3];
    ...
    unit_fill_api(&api);
    ED301V2_CHECK(ed301v2_rust_api_valid(&api), "complete ABI table accepted");
     ...
     */
    {
        ...
        unsigned char signature_value[ED301V2_SIGNATURE_BYTES] = { 0 };
        int inner = 1;
        ...
        ED301V2_CHECK(verify != NULL
                ...
                && unit_error_reason == ED301V2_R_INVALID_STATE,
        ...
        ED301V2_CHECK(verify != NULL
                ...
                && unit_error_reason == ED301V2_R_INVALID_PARAMETER,
    ...
    ED301V2_CHECK(!ed301v2_core_version_text_is_supported("3.4.999"),
        "OpenSSL 3.4 predates the tested source/API minimum");
    ED301V2_CHECK(!ed301v2_core_version_text_is_supported("3.5.6"),
        "OpenSSL 3.5 patch below the tested minimum rejected");
    ED301V2_CHECK(ed301v2_core_version_text_is_supported("3.5.7"),
        "OpenSSL 3.5.7 source/API minimum accepted");
    ED301V2_CHECK(ed301v2_core_version_text_is_supported("3.5.999"),
        "OpenSSL 3.5 patch update accepted");
    ED301V2_CHECK(ed301v2_core_version_text_is_supported("3.6.0"),
        "later OpenSSL 3 minor accepted");
    ED301V2_CHECK(ed301v2_core_version_text_is_supported("3.99.1"),
        "later OpenSSL 3 minor accepted");
    ED301V2_CHECK(!ed301v2_core_version_text_is_supported("4.0.1"),
        "different OpenSSL major rejected");
#else
    ED301V2_CHECK(!ed301v2_core_version_text_is_supported("4.0.0"),
        "OpenSSL 4 patch below the source/API minimum rejected");
    ED301V2_CHECK(ed301v2_core_version_text_is_supported("4.0.1"),
        "OpenSSL 4.0.1 source/API minimum accepted");
    ED301V2_CHECK(ed301v2_core_version_text_is_supported("4.0.999"),
        "OpenSSL 4 patch update accepted");
    ED301V2_CHECK(ed301v2_core_version_text_is_supported("4.1.0"),
        "later OpenSSL 4 minor accepted");
    ED301V2_CHECK(ed301v2_core_version_text_is_supported("4.99.1"),
        "later OpenSSL 4 minor accepted");
    ED301V2_CHECK(!ed301v2_core_version_text_is_supported("3.99.99"),
        "different OpenSSL major rejected");
#endif
    ED301V2_CHECK(!ed301v2_core_version_text_is_supported("invalid"),
        "malformed core version rejected");
    ED301V2_CHECK(!ed301v2_core_version_text_is_supported("3.5"),
        "incomplete core version rejected");

    settable = curve301_private_codec_settable_ctx_params(NULL);
    ...
    ED301V2_CHECK(codec_default != NULL
            && curve301_private_codec_set_ctx_params(&codec, cipher) == 1
    ...
    ED301V2_CHECK(curve301_private_codec_set_ctx_params(
